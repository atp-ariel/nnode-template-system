...
class VIPSingleEquation(Template):
    ...
    def __init__(self):
        super().__init__("__templates__/simple-without-params.json")



class PVIPSingleEquation(Template):
    NAME = "pvip"
    DESCRIPTION = "Solve PVIP of a single ODE"
    ...
    @property
    def a_min(self) -> AnyStr:
        return self._config["a_min"]

    @a_min.setter
    def a_min(self, x: float):
        self._config["a_min"] = x

    @property
    def a_max(self) -> AnyStr:
        return self._config["a_max"]

    @a_max.setter
    def a_max(self, x: float):
        self._config["a_max"] = x
    ...
    def number_of_ai(self):
        return self._config["number_of_ai"]

    @number_of_ai.setter
    def number_of_ai(self, x: int):
        self._config["number_of_ai"] = x
    ...
    def __init__(self):
        super().__init__("__templates__/simple-with-params.json")
